...
<head>
    ...
    <title>Ujikom Klinik Rifqi</title>
</head>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 my-3">
                <div class="card text-dark" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        <a href="index.php?hal=tambah" class="btn btn-success ms-3">Form</a><br>
                        <a href="#" class="btn btn-success ms-3 mt-3">Data Pasien</a><br>
                        <a href="#" class="btn btn-success ms-3 mt-3">Data Dokter</a><br>
                        <a href="#" class="btn btn-success ms-3 mt-3">Data Poli</a><br>
                        <a href="index.php?hal=data" class="btn btn-success ms-3 mt-3">Berobat</a>
                    </div>
                </div>
